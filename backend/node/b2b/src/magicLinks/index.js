...
export async function loginOrSignup(req, res) {
    const loginSignupReq = req.body;
 ...
 */
export async function discoverySend(req, res) {
    const discoveryReq = req.body;
 ...
 */
export async function discoveryAuthenticate(req, res, next) {
    // Retrieve the token from the query parameter.
    const token = req.query.token;
