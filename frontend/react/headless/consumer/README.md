# Stytch Consumer React Headless SDK Example

A React application demonstrating Stytch Consumer authentication with custom UI components. Users can authenticate via email magic links and manage sessions.
